package kr.go.rastech.ptl.center.qna.dao;
...
public interface QnaDao {
	...
	/**
	  ...
	  */
	public int selectQnaSeq() throws IOException, SQLException , NullPointerException;

	/**
	  * @Method Name : insertQnaMng
	  * @작성일 : 2023. 7. 13.
	  * @작성자 : User
	  * @변경이력 : 
	  * @Method 설명 :
	...
	public void updateQnaImgFile(Map<String, Object> param) throws IOException, SQLException , NullPointerException;
