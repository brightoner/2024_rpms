 ...
 ******************************************************************/
package kr.go.rastech.commons.error.controller;
 ...
 * Package : kr.go.ncmiklib.commons.error.controller
 *
 * 에러 처리 Controller.
 *
 * </pre>
...
public class ErrorController extends BaseController {
    ...
    * @return
    */
   @RequestMapping("/error/errorout.do")
   public String errorout(HttpServletRequest request, HttpServletResponse response , ModelMap model) {
       ...
       map.put("SERVLET_NAME", request.getAttribute("javax.servlet.error.servlet_name"));
           ...
           if(map.get("STATUS_CODE") == null){
        	   ...
        	   status_code = Integer.parseInt(String.valueOf(map.get("STATUS_CODE")));
           }
   ...
   * @return
   */
  @RequestMapping("/error/unsupport/extention.do")
  public String unsupportedExtention(HttpServletRequest request, HttpServletResponse response , ModelMap model) {
	   System.out.println("*****************************************************");
	   System.out.println("*****************************************************");
	   System.out.println("*****************************************************");
	   System.out.println("*****************************************************");
