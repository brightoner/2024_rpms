   ...
   <footer class="footer bg-dark"  id ="footer">
        <div class="container">
	       ...
	       <div class="footer-wrap">
			 <div class="foot-logo"><img src="${ctxt}/resources/images/common/logo_rastech_wh.svg" style="width: 200px;height: 50px;"  alt="국립의과학지식센터 로고"/></div>
			 <div class="foot-con">
				<%--  <ul class="foot-menu">
				 ...
				 <p class="address">(34037) 대전광역시 유성구 갑천로 361-39 </p>
				 <p class="address">361-35, Gapcheon-ro, Yuseong-gu, Daejeon, Republic of Korea</p>
				 <ul class="foot-info-list">
					 <li><span>TEL:&nbsp;</span><p>042-862-7560~1</p></li>
					 <li><span>FAX:&nbsp;</span><p>042-862-7562</p></li>					 
				 </ul>
				 <p class="copyright">Copyright 2024 by Rastech Co. All Rights Reserved.</p>
				<div class="wa-mark">
				</div>
			 </div>
