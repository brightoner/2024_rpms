...
<link rel="stylesheet" type="text/css" href="${ctxt}/resources/css/new/styles.css?ver=1"/><!-- Core theme CSS (includes Bootstrap)-->
<%-- <link rel="stylesheet" type="text/css" href="${ctxt}/resources/css/new/streaming.css?ver=1"/> --%>
<link rel="stylesheet" type="text/css" href="${ctxt}/resources/css/mngMenu.css?ver=1">
<link rel="stylesheet" type="text/css" href="${ctxt}/resources/css/new/item.css?ver=1"/>
