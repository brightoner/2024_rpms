...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
	...
	function fn_save(){
		...
		var item = serializeFormToJSON($("form[name='reqFrm']"));
        ...
        fn_showCustomConfirm("question","저장하시겠습니까?", function() {
		    ...
		    $.ajax({
		        url: '${ctxt}/apply/req/updateReqProj.do',
	...
	function fn_delete(){
		...
		fn_showCustomConfirm("warning","삭제하시겠습니까?", function() {
			...
			$.ajax({
		        url: '${ctxt}/apply/req/chkSelGb.do',
		        data: params,
		        type: 'POST', 
		        dataType: 'json',	 
				success: function(result){			
					if(result.result != 0){
						...
						form.action = '${ctxt}/apply/req/deleteReqProj.do'; 
						form.submit();
					}
				},
				error: function(request,status,error) {
...
<div id="right_content">   
	<h3 class="page_title" id="title_div"><span class="adminIcon"></span>연구과제 신청 상세</h3>  
	...
	<table class="table_v">  
	 ...
	 <form name="reqFrm" method="post"  action=""  enctype="multipart/form-data">
		...
		<input type="hidden" id="agmt_gb" name="agmt_gb" value="${data.agmt_gb}">
		<input type="hidden" id="agmt_dt" name="agmt_dt" value="${data.agmt_dt}">
		<input type="hidden" id="agmt_info" name="agmt_info" value="${data.agmt_info}">
		
			<h4 style="margin-top: 20px;"><i class="fas fa-chevron-circle-right  fa-sm" style="color:#314873" aria-hidden="true"></i>&nbsp;연구과제 신청 정보</h4>
	 	...
	 	<table class="table_v" id="projDetailTable">  
			...
			<tbody>
				<tr>
					...
					<td>
						 <input type="date" name="req_dt" id="req_dt"  value ="${data.req_dt}" max="9999-12-31" min="1111-01-01">		 
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3">
						<div class="inputs-in-a-row">
							 ...
							 <input type="text" name="mOrg_nm" id="mOrg_nm" value="${data.org_nm}" style="width:25%;ime-mode:active" readonly="readonly">
							 <input type="text" name="mOrg_crm_no" id="mOrg_crm_no" value="${data.org_crm_no}" style="width:10%;ime-mode:active" readonly="readonly"> 
							 <input type="text" name="mOrg_address" id="mOrg_address" value="${data.org_address}" style="width:45%;ime-mode:active" readonly="readonly"> 
					...
					<tr name="respTr">
						...
						<td colspan="3">
							<div class="inputs-in-a-row">
								 ...
								 <input type="text" name="resp_mbtlnum" id="resp_mbtlnum" value="${respList.resp_mbtlnum}" style="width:15%;background-color:#e9ecef;ime-mode:active" readonly="readonly"> 
