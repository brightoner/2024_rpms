...
function fn_search(page){
    ...
    $.ajax({
        url: '${ctxt}/center/qna/readQnaList.do',
        data: params,
        type: 'POST',
...
function fn_qnadtl(seq){
	...
	form.action = '${ctxt}/center/qna/qnaDetail.do';
	form.submit();	
}
function fn_write(){
	$('#qna_id').val("");
	var form = document.writeForm;
	form.action = '${ctxt}/center/qna/qnaWrite.do';
	form.submit();	
}
	...
	<div id="divRefreshArea">
		<form name="writeForm" method="post" action="">
			<div id="spot" class="cscenter">
				<div class="img-box"><h1 class="page_title">1:1 문의하기</h1></div>				 
			</div>
			<div class="grid_box">   
		...
		<div class="admin">
			...
			<div align="right">
		  		...
		  		<a onclick="javascript:fn_write();" class="btn btn-secondary">1:1 문의하기</a>
			</div>
			<!--//버튼 -->
		</div>
	</div>
