...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>   
	...
	function lf_cal_add(ths){
		ths.one().datepicker({
			...
			showOn:"button",
			buttonImage: '/resources/images/btn_date.png', 	        
...
<div id="right_content">   
	<h3 class="page_title" id="title_div"><span class="adminIcon"></span>팝업관리 등록</h3>  
	...
	<form name="popupFrm" method="post"  action="">	
		<input type="hidden" name="save_type" id="save_type" value="I" />
	...
	<table class="table_v">  
		...
		<tr>
			...
			<td class="bor_top flex_box">		
				<div><input type="radio" name="pop_type" id="pop_type_n"  value="P" checked="checked"> <label for="pop_type_n">일반팝업</label></div>
			</td>
		</tr>
		<tr>
			<th>팝업제목</th>
			<td>
				<input type="text" name="pop_title" id="pop_title" value="" style="width:100%;ime-mode:active">
			</td>
		</tr>
		<tr>
			<th>팝업시점</th>
			<td class="flex_box">
				<div><input type="radio" name="pop_target" id="pop_target_n" value="N" checked="checked"> <label for="pop_target_n">접속시</label></div>
				<div><input type="radio" name="pop_target" id="pop_target_y" value="L" > <label for="pop_target_y">로그인시</label></div>
			</td>
		</tr>						
		<tr>
			<th>게시기간</th>
			<td class="flex_box">
			<div><input class="datepicker picker_l" type="text" name="start_date" id="start_date" value="" maxlength="10" style="width:30%" /></div>
			<div><input class="datepicker picker_l" type="text" name="end_date" id="end_date" value="" maxlength="10" style="width:30%"/></div>
			</td>      
		</tr>
		<!-- 텍스트입력 -->
		<tr>
			<th>내용</th>  
			<td>				
				<textarea name="pop_contents" id="pop_contents" rows="10" style="width:100%;ime-mode:active;display:none;"></textarea>
		...
		<tr>
			<th>자세히보기 URL</th>
			<td> 
				<input type="text" name="pop_url" id="pop_url" value="" placeholder="http:// 또는 https:// 로 시작" style="width:100%;ime-mode:disabled">
			</td>
		</tr>
		<tr>
			<th>링크방법</th>
			<td class="flex_box">
				<div><input type="radio" name="pop_link" id="pop_link_n" value="N" > <label for="pop_link_n">바로 열기</label></div>
				<div><input type="radio" name="pop_link" id="pop_link_y" value="Y" checked="checked"> <label for="pop_link_y">새창으로 열기</label></div>
			</td>
		</tr>							
		<tr>
			<th>팝업크기</th>
			<td>						
				...
				<!-- div의 형태의 팝업으로 변경하서 기존 width height 항목은 입력 하지 않는다 . 에디터에서 처리       // db에  기본값은 넣도록 그냥 둠.-->
				 	<div style="display: none;">WIDTH : <input type="text" name="pop_width" id="pop_width" size="4" maxlength="4" value="400" onKeyPress='onlyNumber(this)' style="text-align:center;ime-mode:disabled"></div>
				 	<div style="display: none;">HEIGHT : <input type="text" name="pop_height" id="pop_height" size="4" maxlength="4" value="500" onKeyPress='onlyNumber(this)' style="text-align:center;ime-mode:disabled"></div> 
					<div>X좌표 : <input type="text" name="pop_x" id="pop_x" size="4" maxlength="4" value="100" onkeyup='onlyNumber(this)' style="ime-mode:disabled" class="ma_t_3 text_c"></div>
					<div>Y좌표 : <input type="text" name="pop_y" id="pop_y" size="4" maxlength="4" value="100" onkeyup='onlyNumber(this)' style="ime-mode:disabled" class="ma_t_3 text_c"></div>
				</div>
			</td>	  
		</tr>
		</tbody>
...
<form name ="popViewForm">
	<input type="hidden" id="pop_seq" name="pop_seq" value="" alt="fParameter" />
