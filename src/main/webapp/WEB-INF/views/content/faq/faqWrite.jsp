...
<%-- 	<script src="${ctxt}/resources/js/egovframework/com/cmm/fms/EgovMultiFile.js" type="text/javascript" ></script> --%>
	...
	function fn_save(){
		...
		if(confirm("저장하시겠습니까?") ==true ){
			...
			form.action = '${ctxt}/content/faq/insertFaq.do';
			form.submit();	
		}
	}
	...
	<table class="table_v">  
		...
		<tbody>
			...
			<tr>
				<th>제목</th>
				<td>
					<input type="text" name="faq_title" id="faq_title" value="" style="width:100%;ime-mode:active">
				</td>
			</tr>
			...
			<tr>
				<th>표시순번</th>
				<td>
					<input type="text" name="faq_order" id="faq_order" value="" style="width:20%;ime-mode:active">
				</td>
			</tr>
			<tr>
				<th>내용</th>  
				<td>				
					<textarea name="faq_contents" id="faq_contents" rows="10" style="width:100%;ime-mode:active"></textarea>
