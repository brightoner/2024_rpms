...
function fn_search(page){
    ...
    $.ajax({
        url: '${ctxt}/content/noti/readNotiList.do',
        data: params,
        type: 'POST',
				...
				xmlList.each(function(cnt){
					...
					****************************************************************/
					...
					if(top_status == '0'){
						...
						html += ' <td>'+'<img src="${ctxt}/resources/images/sub/important_notice1.png" width="15" height="13" alt="중요공지" >'+'</td>';
					}
...
function fn_notidtl(seq){
	...
	form.action = '${ctxt}/content/noti/notiDetail.do';
	form.submit();	
}
function fn_write(){
	$('#noti_id').val("");
	var form = document.writeForm;
	form.action = '${ctxt}/content/noti/notiWrite.do';
	form.submit();	
}
...
<div id="container">
	<div id="divRefreshArea">
		<form name="writeForm" method="post" action="">
			<!-- <div id="spot">
				<div class="img-box"><h1 class="page_title">공지사항 관리</h1></div>				 
			</div> -->
				<h3 class="page_title" id="title_div"><span class="adminIcon"></span>공지사항 관리</h3> 
			<div class="grid_box">   
