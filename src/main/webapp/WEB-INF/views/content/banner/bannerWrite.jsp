...
<%-- 	<script src="${ctxt}/resources/js/egovframework/com/cmm/fms/EgovMultiFile.js" type="text/javascript" ></script> --%>
	...
	function fn_save(){
		...
		{
			fn_showCustomAlert("베너 제목을 입력 하세요.");
			$("#banner_title").val("");
			$('#banner_title').focus();
			return false;
		}
...
<div id="right_content">   
	...
	<form name="bannerFrm" method="post"  action=""  enctype="multipart/form-data">	
		...
		<input type="hidden" name="banner_seq" id = "banner_seq" value="" />
	<table class="table_v">  
		<colgroup>
			<col width="20%">
			<col width="*">  
		...
		<tr>
			<th>배너 제목</th>
			<td>
				<input type="text" name="banner_title" id="banner_title" value="" style="width:100%;ime-mode:active">
			</td>
		</tr>
		<tr>
			<th>사용여부</th>
		...
		<tr>
			<th>내용</th>  
			<td>				
				<textarea name="banner_contents" id="banner_contents" rows="10" style="width:100%;ime-mode:active;display:none;"></textarea>
		...
		<%-- <tr>
		    ...
		    <td>
		    		<c:import url="/cmm/fms/selectImageFileInfs.do" charEncoding="utf-8">
						<c:param name="atchFileId" value="${ptlElibWebDBVO.atchFileId}" />
			...
			<th>배너 이미지</th>
		  	<td>
				<table class="borderless">
					...
					<tr>
						<td>
						    <input id="egovComFileUploader" type="file" title="파일첨부"  name="file_0" title="파일첨부" data-width="600" data-height="400"/>
						</td>
					</tr>
	    			<!-- <tr>
