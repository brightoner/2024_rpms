	...
	var Draw = function() {
		...
		this.render = function() {
            if(!_.typeCheck("function", this.draw)) {
            	...
            	console.log("JUI_CRITICAL_ERR: 'draw' method must be implemented");
            }
        ...
        function loadPath(uri) {
            ...
            _.ajax({
                ...
                fail: function(xhr) {
                    ...
                    console.log("JUI_CRITICAL_ERR: Failed to load resource");
                }
            });
...
jui.define("chart.theme.jennifer", [], function() {
    ...
    return {
        fontFamily : "Nanum Gothic,돋움,Dotum,Noto Sans Korean,sans-serif",
    	backgroundColor : "#fff",
        colors : themeColors,
        ...
        // Widget styles
        titleFontColor : "#2c4688",
        titleFontSize : 17,
        titleFontWeight : "bold",
        legendFontColor : "#2c4688",
        legendFontSize : 14,
...
jui.define("chart.topology.sort.random", [], function() {
    return function(data, area, space) {
        ...
        for(var i = 0; i < data.length; i++) {
            var x = Math.floor(inner_random() * (area.width - space)),
                y = Math.floor(inner_random() * (area.height - space));
...
jui.define("chart.topology.sort.linear", [], function() {
    ...
    function getRandomRowIndex(row_cnt) {
        var row_index = Math.floor(inner_random() * row_cnt);
